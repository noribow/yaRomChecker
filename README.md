...
`verify` performs a quick scan, then matches hashes against Logiqx DAT files listed under `dats:` in the YAML config. Collection files not in the DAT are extra; DAT ROMs not on disk are missing.
